/*
allow sending messages from main to specific threadid
allow broadcasting messages to all threads
allow broadcasting from thread to other threads
allow control of these options so they can be turned on/off (security!)
*/
