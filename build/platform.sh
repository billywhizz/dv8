...
if [[ "$CONFIG" == "release" ]]; then
    ...
    export LDFLAGS="-pthread -m64 -Wl,-z,norelro -Wl,--start-group /deps/mbedtls/library/libmbedcrypto.a $DV8_OUT/dv8main.o $DV8_OUT/dv8.a $V8_DEPS/libv8_monolith.a $UV_DEPS/libuv.a -ldl -Wl,--end-group"
else
...
rm -f $DV8_OUT/dv8.a
ar crsT $DV8_OUT/dv8.a $DV8_OUT/buffer.o $DV8_OUT/env.o $DV8_OUT/dv8.o $DV8_OUT/modules.o $DV8_OUT/loop.o $DV8_OUT/timer.o $DV8_OUT/fs.o $DV8_OUT/process.o $DV8_OUT/tty.o $DV8_OUT/libz.o $DV8_OUT/os.o $DV8_OUT/socket.o $DV8_OUT/thread.o $DV8_OUT/udp.o $DV8_OUT/mbedtls.o $DV8_OUT/httpParser.o $DV8_OUT/miniz.o $DV8_OUT/http_parser.o
if [[ "$CONFIG" == "release" ]]; then
