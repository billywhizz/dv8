...
export LDFLAGS="-shared -pthread -m64 -Wl,-soname=$MODULE_NAME.so -o ./$MODULE_NAME.so -Wl,--start-group /usr/lib/libssl.a /usr/lib/libcrypto.a ./$MODULE_NAME.o ./$MODULE_NAME.binding.o -Wl,--end-group -lz"
