...
if [[ "$CONFIG" == "release" ]]; then
    export CCFLAGS="-D$TRACE -I$V8_INCLUDE -I$UV_INCLUDE -I$BUILTINS -I$DV8_SRC -msse4 -pthread -Wall -Wextra -Wno-unused-result -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function -m64 -O3 -fno-omit-frame-pointer -fno-rtti -ffast-math -fno-ident -fno-exceptions -fmerge-all-constants -fno-unroll-loops -fno-unwind-tables -fno-math-errno -fno-stack-protector -fno-asynchronous-unwind-tables -ffunction-sections -fdata-sections -std=gnu++1y"
    export LDFLAGS="-pthread -m64 -Wl,-z,norelro -Wl,--start-group $DV8_OUT/dv8main.o $DV8_OUT/dv8.a $V8_DEPS/libv8_monolith.a $UV_DEPS/libuv.a -lz -ldl -Wl,--end-group"
else
    export CCFLAGS="-D$TRACE -I$V8_INCLUDE -I$UV_INCLUDE -I$BUILTINS -I$DV8_SRC -msse4 -pthread -Wall -Wextra -Wno-unused-result -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function -m64 -g -fno-omit-frame-pointer -fno-rtti -fno-exceptions -std=gnu++1y"
    export LDFLAGS="-pthread -m64 -Wl,-z,norelro -Wl,--start-group $DV8_OUT/dv8main.o $DV8_OUT/dv8.a $V8_DEPS/libv8_monolith.a $UV_DEPS/libuv.a -lz -ldl -Wl,--end-group"
fi
export CC="ccache g++"
...
# create the lib
rm -f $DV8_OUT/dv8.a
ar crsT $DV8_OUT/dv8.a $DV8_OUT/buffer.o $DV8_OUT/env.o $DV8_OUT/dv8.o $DV8_OUT/modules.o $DV8_OUT/libz.o $DV8_OUT/loop.o $DV8_OUT/process.o $DV8_OUT/timer.o $DV8_OUT/thread.o $DV8_OUT/tty.o $DV8_OUT/os.o $DV8_OUT/fs.o $DV8_OUT/socket.o $DV8_OUT/udp.o
$CC -rdynamic $LDFLAGS -s -o out/bin/dv8
